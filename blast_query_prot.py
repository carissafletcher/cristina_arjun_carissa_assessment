...
from Bio.Blast import NCBIXML #XML output

Entrez.email = "crisgarciamorat@gmail.com"
...
print(">>>>>>>>>>>>>>>>>>< Running Multiple Sequence Alignments through BLASTP ><<<<<<<<<<<<<<<<<<<<<<")

query_sequence_test = transcript_dictionary['translation']['prot']
test = blastp_search(query_sequence_test)
